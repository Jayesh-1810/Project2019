            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform"  method="post" modelAttribute="areaVO" action="insertArea.html">
                  <f:hidden path="areaId"/>
                    <fieldset>
                      <div class="form-group">
                        <label for="firstname">City</label>
                        <f:select id="firstname" class="form-control" path="cityVO.cityId">
                        <option>Choose City</option>
                        <f:options items="${cityList}" itemLabel="cityName" itemValue="cityId"/>
                        </f:select> 
                      </div>
                      <div class="form-group">
                        <label for="lastname">Area Name</label>
                        <f:input class="form-control" path="areaName"/>
                      </div>
                       <div class="form-group">
                        <label for="lastname">Pin Code</label>
                        <f:input  class="form-control" path="areaPin" placeholder="Pincode" maxlength="6" />
                      </div>
                    <div class="form-group">
                        <label for="firstname">Area Description</label>
                        <f:textarea path="areaDescription" class="form-control" maxlength="100" rows="2" placeholder="This textarea has a limit of 100 chars."></f:textarea>
                      </div>
