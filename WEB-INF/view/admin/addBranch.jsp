                ...
                <div class="card-body">
                  ...
                  <form class="cmxform" id="signupForm" method="get" action="#">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="firstname" class="form-control" name="firstname" type="text" maxlength="100" rows="2" placeholder="This textarea has a limit of 100 chars."></textarea>
                      </div>
                      
                      <div class="form-group">
                        <label for="firstname">Branch Description</label>
                        <textarea id="firstname" class="form-control" name="firstname" type="text" maxlength="100" rows="2" placeholder="This textarea has a limit of 100 chars."></textarea>
                      </div>
