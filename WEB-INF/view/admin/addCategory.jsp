            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform"  method="post" modelAttribute="categoryVO" action="insertCategory.html">
                  <f:hidden path="categoryId"/>
                    <fieldset>
                      ...
                      <div class="form-group">
                        ...
                        <f:textarea class="form-control" path="categoryDescription" maxlength="100" rows="2" placeholder="This textarea has a limit of 100 chars."></f:textarea>
                      </div>
