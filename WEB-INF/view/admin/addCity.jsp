          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                ...
                <!--  id="signupForm" --> <f:form class="cmxform" modelAttribute="cityVO" method="post" action="insertCity.html">
                  <f:hidden path="cityId"/>
                    <fieldset>
                      <div class="form-group">
                        <label for="firstname">City Name</label>
                      <!-- id="firstname" -->  <f:input  class="form-control" path="cityName"/>
                      </div>
                      
                      <div class="form-group">
                        <label for="firstname">City Description</label>
                     <!-- id="firstname" -->   <f:textarea  class="form-control" path="cityDescription" maxlength="100" rows="2" placeholder="This textarea has a limit of 100 chars."></f:textarea>
                      </div>
