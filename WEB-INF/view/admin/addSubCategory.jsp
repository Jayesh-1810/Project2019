            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <f:form class="cmxform" method="post" action="insertSubCategory.html" modelAttribute="subcategoryVO">
                  ...
                  <f:hidden path="subcategoryId"/>
                    ...
                    <fieldset>
                      <div class="form-group">
                        ...
                        <f:select path="categoryVO.categoryId" id="firstname" class="form-control" name="firstname">
         <!-- categoryVO.categoryId is use as foreign key here so only access categoryId -->
                        <option>Choose Category</option>
                        <f:options items="${categoryList}" itemLabel="categoryName" itemValue="categoryId"/>
                        <!-- itemlabel is use for show names on screen and itemvalue is use as forign key  -->
                        </f:select> 
                      </div>
                      <div class="form-group">
                        <label for="lastname">SubCategory Name</label>
                        <f:input  class="form-control" path="subcategoryName"/>
                      </div>
                    <div class="form-group">
                        <label for="firstname">Sub Category Description</label>
                        <f:textarea class="form-control" path="subcategoryDescription" maxlength="100" rows="2" placeholder="This textarea has a limit of 100 chars."/>
                      </div>
