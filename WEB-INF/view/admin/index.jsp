...
<head>
  ...
  <link rel="stylesheet" href="<%=request.getContextPath() %>/adminResources/css/cssvendor.bundle.base.css">
  <link rel="stylesheet" href="<%=request.getContextPath() %>/adminResources/css/cssvendor.bundle.addons.css">
  <!-- endinject -->
