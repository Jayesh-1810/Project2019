        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Post Complaint</h4>
                  <%@taglib prefix="f" uri="http://www.springframework.org/tags/form" %>
                  
                  <f:form class="cmxform"  action="updateComplaint" modelAttribute="complaintedit" method="post">
                  	<f:hidden path="complaintId"/>
                    <f:hidden path="loginVO.loginId"/>
                    <fieldset>
                      <div class="form-group">
                        <label for="firstname">Complaint Title</label>
                        <f:input path="complaintTitle"  class="form-control" />
                      </div>
                      
                      <div class="form-group">
                        <label for="firstname">Complaint</label>
                        <f:textarea class="form-control" path="complaintDescription" maxlength="100" rows="2" placeholder="This textarea has a limit of 100 chars."></f:textarea>
                      </div>
                      
                      <div class="form-group">
                        <label for="firstname">Complaint Reply Description</label>
                        <f:textarea class="form-control" path="complaintReplyDescription" maxlength="100" rows="2" placeholder="This textarea has a limit of 100 chars."></f:textarea>
                      </div>
