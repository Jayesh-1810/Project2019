                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                       <c:forEach items="${areaList}" var="areaVO" >
                        <tr>
                            <td>${areaVO.areaId}</td>
                            <td>${areaVO.cityVO.cityName}</td>
                            <td>${areaVO.areaName}</td>
                            <td>${areaVO.areaPin}</td>
                            <td>${areaVO.areaDescription}</td>
                             <td>
                             <a href="/deleteArea?areaId=${areaVO.areaId}">
            					<button type="submit">Delete</button>
           					 </a>
           					<td>
           					<a href="/editArea?areaId=${areaVO.areaId}">
