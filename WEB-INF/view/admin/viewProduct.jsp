                    ...
                    <table id="order-listing" class="table">
                      ...
                      <c:forEach items="${productList}" var="productVO" >
                        <tr>
                            ...
                            <td>${productVO.categoryVO.categoryName}</td>
                            <td>${productVO.subcategoryVO.subcategoryName}</td>
                            <td>${productVO.areaVO.areaName}</td>
                            <td>${productVO.productName}</td>
                            <td>${productVO.productDescription}</td>
                            <td>${productVO.productPrice}</td>
                            <td>
              					<c:forEach items="${productImageList}" var="m">
              						<c:if test="${productVO.productId eq m.productVO.productId}">
                          			 <a href="<%=request.getContextPath()%>/documents/productImage/${m.productImageName}">
                          				<img src="<%=request.getContextPath()%>/documents/productImage/${m.productImageName}" alt="product_Images" >
                          			</a>
                          			</c:if>
                          		</c:forEach>
                          	</td>
                             <td>
                             <a href="deleteProduct?productId=${productVO.productId}">
            					<button type="submit">Delete</button>
           					 </a>
           					<td>
           					<a href="/editProduct?productId=${productVO.productId}">
