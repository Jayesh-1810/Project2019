                ...
                <div class="col-12">
                  <div class="table-responsive">
                    ...
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                      <c:forEach items="${subcategoryList}" var="subcategoryVO" >
                        <tr>
                            <td>${subcategoryVO.subcategoryId}</td>
                            <td>${subcategoryVO.categoryVO.categoryName}</td> 
 <!-- subcategoryVO.categoryVO.categoryName here subcategoryVO is var and categoryVO is getter setter methods categoryVO object access for category data(variables) and 
 categoryName is use for only access categoryName from categoryVO object -->
                              <td>${subcategoryVO.subcategoryName}</td>
                            <td>${subcategoryVO.subcategoryDescription}</td>
                            <td>
                             <a href="deleteSubCategory?subcategoryId=${subcategoryVO.subcategoryId}">
            					<button type="submit">Delete</button>
           					 </a>
           					<td>
           					<a href="/editSubCategory?subcategoryId=${subcategoryVO.subcategoryId}">
  ...
  <script src="<%=request.getContextPath() %>/adminResources/s/template.js"></script>
