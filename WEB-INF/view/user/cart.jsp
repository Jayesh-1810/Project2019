                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="cart-table table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="pro-thumbnail"><a href="#"><img class="img-fluid" src="<%=request.getContextPath() %>/userResources/images/product-1.jpg" alt="Product" /></a></td>
                                    ...
                                    <tr>
                                        <td class="pro-thumbnail"><a href="#"><img class="img-fluid" src="<%=request.getContextPath() %>/userResources/images/product-2.jpg" alt="Product" /></a></td>
                                    ...
                                    <tr>
                                        <td class="pro-thumbnail"><a href="#"><img class="img-fluid" src="<%=request.getContextPath() %>/userResources/images/product-3.jpg" alt="Product" /></a></td>
                                    ...
                                    <tr>
                                        <td class="pro-thumbnail"><a href="#"><img class="img-fluid" src="<%=request.getContextPath() %>/userResources/images/product-4.jpg" alt="Product" /></a></td>
