                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="contact-message">
                            <h2>Complaint</h2>
                            <form:form action="insertComplaint" modelAttribute="complaintadd" method="post" >
                            
                                <div class="row">
                            	
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <form:input  path="complaintTitle" placeholder="complain Subject *" type="text" required="required"/>
                                    </div>
                         
                                    <div class="col-12">
                                        <div class="contact2-textarea text-center">
                                            <form:textarea placeholder="complain Description *" path="complaintDescription"  class="form-control2" required="required"/>
                                        </div>
