                        ...
                        <div class="breadcrumb-wrap">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">product details box</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 order-1 order-lg-2">
                        ...
                        <div class="product-details-inner">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="product-slider-box">
                                        <div class="ht-slick-slider-wrap">
                                            <div class="ht-slick-slider slick-row-15" data-slick='{"slidesToShow": 3, "slidesToScroll": 1, "speed": 1000, "arrows": true, "prevArrow": ".prev-box", "nextArrow": ".next-box", "responsive":[{"breakpoint":768, "settings":{"slidesToShow": 2}}, {"breakpoint":480, "settings":{"slidesToShow": 1}}]}'>
                                            ...
                                            <div class="ht-slick-nav">
                                                <button class="prev-box"><i class="ion-ios-arrow-left"></i></button>
                                                <button class="next-box right"><i class="ion-ios-arrow-right"></i></button>
                                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="product-details-des box-layout pt-34">
